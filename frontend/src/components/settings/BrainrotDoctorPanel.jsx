/**
 * The realm-wide BrainrotDoctor switch. The copy has to be exact about the
 ...
 */
export default function BrainrotDoctorPanel({ enabled, canEdit, onToggle }) {
  return (
    <div className="mt-4 rounded-[20px] border-2 border-info-edge bg-info px-4 py-[13px]">
      <div className="flex items-center gap-3">
        <button
          aria-checked={enabled}
          aria-label="BrainrotDoctor"
        ...
        <div>
          <p className="text-[13.5px] font-extrabold text-[#2F5F82]">BrainrotDoctor</p>
